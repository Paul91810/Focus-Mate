              ...
              child: _buildCard(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("5 completed", style: TextTheme.of(context).bodyLarge),
                    Text("7 remaining", style: TextTheme.of(context).bodyLarge),
                  ],
                ),
              ),
            ),
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 8),
                  Text("Submit report", style: TextTheme.of(context).bodyLarge),
                  Spacer(),
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 8),
                  Text("Team meeting", style: TextTheme.of(context).bodyLarge),
                  Spacer(),
              ...
              child: _buildCard(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    AppSize.commonHeight,
                    Icon(Icons.note, color: AppColors.kPrimaryColor, size: 100),
                  ],
                ),
              ),
            ),
